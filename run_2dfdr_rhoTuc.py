...
startFrom = 7 #number of data set to begin with. 0 for beginning. Good for starting half way through if it cancelled
...
target_root = '/Users/Carlos/Documents/HERMES/reductions/rhoTuc_6.2/' #my laptop

#all science reduced (*red.fits) files will be copied to this directory
final_dir = '/Users/Carlos/Documents/HERMES/reductions/rhoTuc_6.2/'
